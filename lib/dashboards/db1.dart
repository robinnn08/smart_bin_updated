...
// dashboard
class DbOne extends StatefulWidget {
  const DbOne({super.key});

  @override
  State<DbOne> createState() => _DbOneState();
}

class _DbOneState extends State<DbOne> {
  ...
  Future<void> showNotification() async {
    ...
    await flutterLocalNotificationsPlugin.show(
      0,
      'Bin Alert',
      'Bin 1 is almost full. Please check it out!',
  ...
  void pickupStatus() async {
    try {
      final pickSnapshot =
          await databaseReference.child('Read/Tong1/pick').once();
  ...
  Future<void> loadChart1Data() async {
    String jsonString = await getJsonForChart1();
    final jsonResponse = json.decode(jsonString);

    setState(() {
      chart1Data.clear();
      for (Map<String, dynamic> i in jsonResponse) {
        chart1Data.add(Chart1Data.fromJson(i));
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final capacityRef = databaseReference.child('Read/Tong1/capacity1').onValue;
    // weightRef untuk mengambil data berat dari database
    final weightRef = databaseReference.child('Read/Tong1/weight1').onValue;
                              ...
                              return SfCartesianChart(
                                  ...
                                  tooltipBehavior: TooltipBehavior(
                                    ...
                                    builder: (dynamic data,
                                        ...
                                        int seriesIndex) {
                                      String xValue =
                                          chart1Data[pointIndex].timestamp;
                                      String yValue = chart1Data[pointIndex]
                                          .percentage
                                          .toString();
                                      return Padding(
                                  ...
                                  series: <ChartSeries<Chart1Data, String>>[
                                    LineSeries<Chart1Data, String>(
                                        name: 'Capacity',
                                        animationDuration: 2500,
                                        dataSource: chart1Data,
                                        xValueMapper: (Chart1Data cap, _) =>
                                            cap.timestamp.substring(18, 23),
                                        yValueMapper: (Chart1Data cap, _) =>
                                            cap.percentage,
