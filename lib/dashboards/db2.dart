...
class _DbTwoState extends State<DbTwo> {
  ...
  Future<void> loadChart2Data() async {
    ...
    if (jsonResponse.length >= 5) {
      chart2Data.clear(); // Clear the existing chart data
      for (int i = jsonResponse.length - 5; i < jsonResponse.length; i++) {
        chart2Data.add(Chart2Data.fromJson(jsonResponse[i]));
      }
    } else {
  ...
  Widget build(BuildContext context) {
    ...
    final weightRef =
        databaseReference.child('Read').child('Tong2').child('weight2').onValue;
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        leading: Image.asset(
                        ...
                        return SfCartesianChart(
                            ...
                            series: <ChartSeries<Chart2Data, String>>[
                              LineSeries<Chart2Data, String>(
                                  ...
                                  xValueMapper: (Chart2Data cap, _) => cap.day,
